...
<div class="set-1">
    <div class="graph-2 general">
        <h3 class="inner-tittle two">Add New Featured Service</h3>
        <div class="grid-1">
            <div class="form-body">
                <form action="{{route('featuredservices.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                {{csrf_field()}}
